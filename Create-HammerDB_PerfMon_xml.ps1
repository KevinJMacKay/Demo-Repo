<#
For 
.\Create-HammerDB_PerfMon_xml.ps1 -Server LAB1APSQLX466 -Folder C:\gitrepos\Demo-Repo -DurationInMinutes 5
For FCI
.\Create-HammerDB_PerfMon_xml.ps1 -Server "LAB1APSQLA499" -SqlInstanceName "INSTA" -Folder C:\gitrepos\Demo-Repo -DurationInMinutes 10
#>
